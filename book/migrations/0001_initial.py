    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.CharField(blank=True, default='http://18.222.57.174/static/book/images/None_cover.png', max_length=200, verbose_name='封面链接')),
                ('large_cover', models.CharField(default='http://18.222.57.174/static/book/images/None_cover.png', max_length=200, verbose_name='封面大图')),
                ...
                ('pages', models.CharField(blank=True, default='', max_length=10, null=True, verbose_name='页数')),
                ...
                ('mobi_file_size', models.IntegerField(blank=True, null=True, verbose_name='MOBI文件大小（字节）')),
